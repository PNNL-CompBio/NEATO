                          ...
                          column(3,
                                 bsCollapse(
                                   ...
                                   bsCollapsePanel("Data Upload",
                                                  ...
                                                  bsTooltip(id = "inFile", title = "Take pmart midpoint file with proteomics data, 
                                                  or a .csv or .tsv with protein identifiers, log-fold changes, and a p-values columns.", 
                                                            placement = "right", trigger = "hover"),
                                                  checkboxInput(inputId = "testDataButton", label = "Load Test Data"),
                                                  bsTooltip(id = "testDataButton", title = "Loads in yeast test data", 
                                                           placement = "right", trigger = "hover")),
                                 ...
                                 selectInput(inputId = "species",
                                             ...
                                             choices = c("Saccharomyces cerevisiae" = 4932,
                                                         "Mus musculus" = 10090,
                                                         "Homo Sapien" = 9606,
